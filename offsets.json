...
namespace offsets {
    ...
    inline constexpr uintptr_t BeamBrightness = 0x128;
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x6E72130;
    ...
    inline constexpr uintptr_t RenderJobToFakeDataModel = 0x128;
